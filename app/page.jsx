    ...
    <div>
      <section className="w-full flex-center flex-col">
        <h1 className="head_text text-center py-2">
          ...
          <span className="blue_gradient text-center">Make your blog</span>
        </h1><Link href="https://github.com/thakurtech"><p className="desc text-center">Made by Sumit Thakur</p></Link>
      </section>
      <div className="py-7">

...
const About = () => {
  ...
  return (
    <div className="w-full flex-center flex-col"><Image src='/assets/sumit.JPG' alt='Author Image'
     width={200} height={200} className='rounded-lg' />
     <h1 className="head_text text-center py-2">
        
        <br className="max-md:hidden" />
        <span className="blue_gradient text-center">I&#39;m Sumit</span>
    </h1>
    <p className='mt-4 text-xl font-bold leading-[1.15] '>I love to build stuff</p>
   ...
   <Link href="https://github.com/thkurtech"><Image src='/assets/github-mark.png' className='mr-6' alt='Github' width={50} height={50}/></Link>
   <Link href="https://www.linkedin.com/in/sumitthakur7"><Image src='/assets/linkedin.svg' className='mr-6' alt='Linkedin' width={50} height={50}/></Link>
   <div className='flex'>
            ...
            {toggleDropdown && (
              <div className='dropdown place-content-center'>
                ...
                <button
                  type='button'
                    onClick={() => {
                    const text = 'sumit_thakur1@outlook.com';
                    setIsCopied(true);
